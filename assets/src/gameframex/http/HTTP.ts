...
export default class HTTP extends Singleton<HTTP>() {
     ...
     * @param failedCallback 请求失败回调
     */
    get(host: string, data: any, header_parmas: any, successCallback:Function, failedCallback?: Function): void {
        this.request(host, data, "get", header_parmas, successCallback, failedCallback);
    }

    private request(host: string, data: any, method: any, header_parmas: any, successCallback: Function, failedCallback?: Function): void {
        // let xhr: XMLHttpRequest = new XMLHttpRequest();
        // xhr.ontimeout = this .timeout = this.m_timeout;
