...
export default class UtilityMath extends Singleton<UtilityMath>() {
    ...
    public static readonly aVec3: Vec3 = new Vec3();
    public static readonly bVec3: Vec3 = new Vec3();
    public static readonly cVec3: Vec3 = new Vec3();
    public static readonly dVec3: Vec3 = new Vec3();
    public static readonly eVec3: Vec3 = new Vec3();
    public static readonly fVec3: Vec3 = new Vec3();
    public static readonly gVec3: Vec3 = new Vec3();
    public static readonly hVec3: Vec3 = new Vec3();
    /**
     * 弧度制转换为角度值
     * @param {number} radian
     * @returns {number}
     ...
     * @returns {number}
     */
    public static getRadianTwoPoint(p1: Vec2, p2: Vec2): number {
        let xdis = p2.x - p1.x;
        let ydis = p2.y - p1.y;
     ...
     * @returns {number}
     */
    public static getAngleTwoPoint(p1: Vec2, p2: Vec2): number {
        let vy = p2.y - p1.y;
        let vx = p2.x - p1.x;
        let ang;
     ...
     * @return {number}
     * */
    public static getBezierCutAngle(p0: Vec2, p1: Vec2, p2: Vec2, t: number): number {
     ...
     * @return {Vec2}
     * */
    public static getBezierPoint(p0: Vec2, p1: Vec2, p2: Vec2, t: number, point?: Vec2): Vec2 {
        if (!point) {
            point = new Vec2();
        }
     ...
     * @return {Vec2}
     * */
    public static getBezier3Point(p0: Vec2, p1: Vec2, p2: Vec2, p3: Vec2, t: number, point?: Vec2): Vec2 {
        if (!point) {
            point = new Vec2();
        }
        let cx = 3 * (p1.x - p0.x);
     ...
     * @return {number}
     * */
    public static getBezier3CutAngle(p0: Vec2, p1: Vec2, p2: Vec2, p3: Vec2, t: number): number {
     ...
     * @param out
     */
    public static getBezier2Vector3(p1: Vec3, p2: Vec3, p3: Vec3, t: number, out: Vec3): Vec3 {
        let t1 = Math.pow((1 - t), 2);
        let t2 = 2 * t * (1 - t);
        let t3 = t * t;
        out.set(0, 0, 0);
        // p1.scale(t1, UtilityMath.aVec3);
        // out.add3f(UtilityMath.aVec3, out);
     ...
     * @returns 
     */
    public static color2String(color: Color): string {
        var r, g, b, a;
